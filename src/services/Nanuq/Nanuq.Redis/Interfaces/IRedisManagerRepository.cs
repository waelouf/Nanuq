...
public interface IRedisManagerRepository
{
	...
	Task<List<string>> GetListElementsAsync(string serverUrl, int database, string key, ServerCredential? credential = null, int limit = 100);
	...
	Task<List<string>> GetSetMembersAsync(string serverUrl, int database, string key, ServerCredential? credential = null, int limit = 100);
	...
	Task<List<(string member, double score)>> GetSortedSetMembersAsync(string serverUrl, int database, string key, bool ascending = true, ServerCredential? credential = null, int limit = 100);
	...
	Task<List<Dictionary<string, object>>> GetStreamEntriesAsync(string serverUrl, int database, string key, ServerCredential? credential = null, int limit = 100);
