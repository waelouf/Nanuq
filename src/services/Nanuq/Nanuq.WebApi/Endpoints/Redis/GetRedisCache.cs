...
namespace Nanuq.WebApi.Endpoints.Redis
{
	public class GetRedisCache : EndpointWithoutRequest<string?>
	{
		...
		public GetRedisCache(IRedisManagerRepository redisManager, IRedisRepository redisRepository, ICredentialRepository credentialRepository)
		{
		...
		public async override Task HandleAsync(CancellationToken ct)
		{
			...
			var val = await redisManager.GetStringCache(server!, database, key!, credential);
