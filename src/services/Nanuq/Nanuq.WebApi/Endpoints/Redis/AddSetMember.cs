...
public class AddSetMember : Endpoint<AddSetMemberRequest, bool>
{
	private IRedisManagerRepository redisManager;
	private IRedisRepository redisRepository;
	private ICredentialRepository credentialRepository;

	public AddSetMember(IRedisManagerRepository redisManager, IRedisRepository redisRepository, ICredentialRepository credentialRepository)
	{
	...
	public override async Task HandleAsync(AddSetMemberRequest req, CancellationToken ct)
	{
		...
		var result = await redisManager.AddSetMemberAsync(req.ServerUrl, req.Database, req.Key, req.Member, credential);
