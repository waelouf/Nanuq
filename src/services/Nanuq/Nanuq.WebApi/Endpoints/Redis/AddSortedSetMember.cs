...
public class AddSortedSetMember : Endpoint<AddSortedSetMemberRequest, bool>
{
	private IRedisManagerRepository redisManager;
	private IRedisRepository redisRepository;
	private ICredentialRepository credentialRepository;

	public AddSortedSetMember(IRedisManagerRepository redisManager, IRedisRepository redisRepository, ICredentialRepository credentialRepository)
	{
	...
	public override async Task HandleAsync(AddSortedSetMemberRequest req, CancellationToken ct)
	{
		...
		var added = await redisManager.AddSortedSetMemberAsync(req.ServerUrl, req.Database, req.Key, req.Member, req.Score, credential);
