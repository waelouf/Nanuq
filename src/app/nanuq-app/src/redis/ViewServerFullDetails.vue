      ...
      <v-tabs-window v-model="tab">
        <v-tabs-window-item value="server">
          <v-row>
            ...
            <v-card
              ...
              <v-card-text>
                <p>
                  <b>CPU usage:</b> {{ calculateCpuUsage }} %
                </p>
              </v-card-text>
            </v-card>
          </v-row>
        ...
        <v-tabs-window-item value="stats">
          <v-card
            ...
            <v-card-text>
              <p>
                <b>Total Connections:</b> {{ serverDetails.stats.totalConnectionsReceived }}
              </p>
              <p>
...
export default {
  ...
  computed: {
    ...
    calculateCpuUsage() {
      const { cpu } = this.serverDetails;
      return ((cpu.usedCpuUser / cpu.usedCpuSys) * 100).toFixed(2);
    },
  },
  props: {
    serverUrl: {
